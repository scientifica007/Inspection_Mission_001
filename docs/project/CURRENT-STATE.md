...
- Latest physically tested Gallery-correction SHA: `4ac992eb3fb4062ffbd3040db5ef967e3e126fd3`.
- Latest physically tested Gallery-correction artifact: `10273428748` / `gate6c-d-gallery-correction-apk-4ac992eb3fb4062ffbd3040db5ef967e3e126fd3`.
...
- Gate 6C-D **OPEN / IN_PROGRESS — PHYSICAL QUALIFICATION IN PROGRESS**; Q02 and Q03 are physical PASS, Q04 is safe but misclassified and requires physical retest after the narrow correction, Q05 remains protocol-review-required under the current manifest, Q07 correction path and current Q13 durability evidence remain physical PASS results. Gate 6C-D is not closed.
